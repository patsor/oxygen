...
\pagebreak
\subsection{Fuselage}
The aluminium fuselage is 2mm thick and provides connectivity to sensors and drivers.
\begin{figure}[h]
	\centering
	\begin{tikzpicture}
	...
	% draw sections
	\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (6,6.5) -- (6,0) node [black,midway,xshift=1.6cm] {\footnotesize $PCA9685$};
	
	\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (6,14.5) -- (6,6.5) node [black,midway,xshift=1.6cm] {\footnotesize $Wing Mount$};
	
	\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (6,18.3) -- (6,14.5) node [black,midway,xshift=2.2cm] {\footnotesize $Stabilizer Mount$};
	\end{tikzpicture}
...
\begin{figure}[h]
	...
	\draw[dashed] (4,17.7) -- (4,19);
	\draw[dashed] (0,17.7) -- (0,19);
	% -- (0,17.7) -- (0,0);
	...
	% draw sections
	\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (6,2) -- (6,0) node [black,midway,xshift=1.6cm] {\footnotesize $Motor Mount$};
	
	\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (6,8.8) -- (6,2) node [black,midway,xshift=1.6cm] {\footnotesize $RPi Zero$};
	
	\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (6,13) -- (6,8.8) node [black,midway,xshift=2.2cm] {\footnotesize $Power Distribution$};
	
	\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (6,16) -- (6,13) node [black,midway,xshift=1.6cm] {\footnotesize $INA219$};
	
	\draw [decorate,decoration={brace,amplitude=10pt},xshift=-4pt,yshift=0pt] (6,17.7) -- (6,16) node [black,midway,xshift=1.6cm] {\footnotesize $MPU9250$};
	\end{tikzpicture}
