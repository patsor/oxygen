...
#    py = timeit.repeat("mpu6500.calibrate()", setup = "from mpu6500 import MPU6500; {}".format(setup), repeat=r, number=n)

#    print("calibrate (py): best of {}; {} usec per loop".format(r, min(py) / n * 1000000))
